...
class IHMCMS{
  ...
  static Future<void> afficheMenu() async{
    ...
    if(choix == "1"){
      print(Couleur.blue()+"Saisir le nom de la base de donnée (maBaseDeDonnée)"+Couleur.reset());
      String nomBDD = Fonction.saisirString();
      print(Couleur.blue()+"Saisir le nom du compte (admin)"+Couleur.reset());
      String compte = Fonction.saisirString();
      print(Couleur.blue()+"Saisir le môt de passe du compte ()"+Couleur.reset());
